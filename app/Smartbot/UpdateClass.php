...
{
  public $data;
  public $other_update_types = ['edited_message', 'channel_post', 'edited_channel_post', 'inline_query', 'chosen_inline_result', 'shipping_query', 'pre_checkout_query', 'poll', 'poll_answer', 'my_chat_member', 'chat_member','chat_join_request'];
  public $other_message_keys = ['new_chat_member' => '', 'new_chat_members' => '', 'new_chat_participant' => '', 'message_auto_delete_timer_changed' => '', 'left_chat_participant' => '', 'left_chat_member' => '', 'pinned_message' => '' ];
  ...
  {    
    return $this->messageIsset() ? $this->data['message'] : false;
  } 
  ...
  {
    return $this->callbackIsset() ? $this->data['callback_query'] : false;
  }
  ...
  {
    $other_message_keys = $this->other_message_keys;    
  ...
  {
    $other_update_types = $this->other_update_types;
